...
const projects = [
  ...
  { id: 11, name: "Create a North Avenue Gateway", location: "Route 104 Bridge", cost: 300000, totalCost: 310000, description: "This project will install artistic lighting under the Route 104 bridge to create a visual connection between Main Street and the North End Business District.", imagePath: "/images/project11.jpg" },
  { id: 12, name: "Market the Business Improvement District", location: "Branding and Marketing", cost: 50000, totalCost: 85000, description: "This project will develop digital marketing content, a mobile app, and print collateral to promote downtown Webster and enhance awareness of businesses.", imagePath: "/images/project12.jpg" },
  ...
  { id: 20, name: "Establish Harmony Square on Main", location: "58 E. Main St.", cost: 300000, totalCost: 325000, description: "This project will create a flexible open space adjacent to Harmony House that incorporates public art and could be used for small-scale events and gatherings.", imagePath: "/images/project20.jpg" },
      ...
      <main>
        {showInstructions ? (
          <div className="instructions-page">
            ...
            <p>Your responses will be anonymously shared with the Local Planning Committee, which is the committee that will decide which proposed projects get recommended to New York State for potential funding. The next meeting of the Local Planning Committee is Thursday, September 19th at 6:00 PM at Webster Village Hall (28 W. Main Street). This meeting is open to the public and there will be time reserved at the end of the meeting for a public comment period.</p>
