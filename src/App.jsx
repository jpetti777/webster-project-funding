...
const projects = [
  ...
  { id: 3, name: "Enhance Gravino Park", location: "135 Main Street", cost: 1500000, totalCost: 1500000, description: "This project will create a fenced-in dog park at Gravino Park as well as a walking trail around the perimeter of the park. The pavilion will also be updated and electrical connections will be installed in the parking lot to allow for events like food truck rodeos.", imagePath: "/images/project3.jpg" },
  { id: 4, name: "Enhance the Main St. Streetscape", location: "Main Street, from Center Street to Route 350", cost: 750000, totalCost: 750000, description: "This project will replace the sidewalks on both sides of Main Street from Center Street to Route 350. Decorative lamp posts will also be installed to enhance night-time lighting. ", imagePath: "/images/project4.jpg" },
  ...
  { id: 11, name: "Expand 104 Main Commercial Building", location: "104 Main Street", cost: 150000, totalCost: 250000, description: "This project will add a second floor to the 104 Main Street building and will re-configure it to better accommodate a small to mid-size business. This project will also include interior renovations, facade improvements, and upgraded landscaping and parking.", imagePath: "/images/project11.jpg" },
